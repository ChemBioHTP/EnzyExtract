...
pmpt = """You are a diligent assistant specialized in enzyme catalysis. 
...
median_validate = """1. TMP kinase G146A, TMP, 30°C, pH 7.4
...
hard_validate = """1. TMP kinase wild-type, TMP, 30°C, pH 7.4
A. dTMP kinase | dTMP | #4# pH 7.4, 30°C, mutant enzyme G146A <15>
