...
def to_target(enzyme, enzyme_full, organism, df_of_accessions):
    ...
    for ncbi, descriptor in \
        ...
        descriptor = _clean_ncbi_str(descriptor)
...
if __name__ == "__main__":
    submit_ncbi_pick_file(
        read_from="data/enzymes/pick/pick-ncbi-v1.parquet",
        model_name="gpt-4o",
