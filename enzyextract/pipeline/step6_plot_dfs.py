...
def visualize_sns_scatter(df: pl.DataFrame, title, log_ratio_threshold=2):
    ...
    # KM scatter plot
    sns.scatterplot(data=df, x="log_km_2", y="log_km_1", hue="km_valid", 
                    alpha=0.5, ax=ax1)
    ...
    ax1.set_xlabel('log10(Km_2) known')
    ax1.set_ylabel('log10(Km_1) predicted')
    ...
    # kcat scatter plot
    sns.scatterplot(data=df, x="log_kcat_2", y="log_kcat_1", hue="kcat_valid", 
                    alpha=0.5, ax=ax3)
    ax3.set_xlabel('log10(kcat_2) known')
    ax3.set_ylabel('log10(kcat_1) predicted')
...
def visualize_sns_kde(df: pl.DataFrame, title):
    ...
    df = df.with_columns([
        pl.col('km_value_1').log10().alias('log_km_1'),
        pl.col('km_value_2').log10().alias('log_km_2'),
        pl.col('kcat_value_1').log10().alias('log kcat_1'),
        pl.col('kcat_value_2').log10().alias('log_kcat_2')
    ])
